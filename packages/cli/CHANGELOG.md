...
- b96cbc0: Include symbol `references` edges in execution-context and impact graphs so Laravel command registrations such as `Kernel::$commands` surface through query APIs and MCP responses.
