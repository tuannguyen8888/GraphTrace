...
const enMessages = {
  ...
  app: {
    ...
    symbolGraphConfidenceWeak: "Weak",
    symbolGraphConfidenceAll: "All",
    symbolGraphShowWeakerEdges: "Show weaker edges",
    symbolGraphExpandCallers: "Expand callers",
    symbolGraphExpandCallees: "Expand callees",
    symbolGraphOpenImpact: "Open impact",
    symbolGraphWeakWarning: "Contains weak-confidence edges.",
...
const viMessages: typeof enMessages = {
  ...
  app: {
    ...
    symbolGraphConfidenceWeak: "Yếu",
    symbolGraphConfidenceAll: "Tất cả",
    symbolGraphShowWeakerEdges: "Hiện cạnh yếu hơn",
    symbolGraphExpandCallers: "Mở rộng callers",
    symbolGraphExpandCallees: "Mở rộng callees",
    symbolGraphOpenImpact: "Mở impact",
    symbolGraphWeakWarning: "Có cạnh với độ tin cậy yếu.",
    symbolGraphCallers: "Callers",
    symbolGraphCallees: "Callees",
    symbolGraphRoutes: "Routes",
    symbolGraphSinks: "Sinks",
